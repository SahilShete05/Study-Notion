...
const CourseDetails = () => {
    ...
    const handleAddToCart = () => {
        ...
        if (cart.some((item) => item._id === courseId)) {
            ...
            <div className='relative w-full bg-richblack-800'>
                <div className='mx-auto box-content px-4 lg:w-[1260px] 2xl:relative '>
                    <div className='mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]'>
                        ...
                        <div className='z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-richblack-5'>
                            ...
                            <div className='flex flex-wrap gap-5 text-lg'>
                                <p className='flex items-center gap-2'>
                                    <IoIosInformationCircleOutline /> Created At {formatDate(createdAt)}
                                </p>
                                <p className='flex items-center gap-2'>
                                    <BsGlobe /> English
                                </p>
                        ...
                        {/* BUY CARD FOR SMALL & MEDIUM SCREENS */}
                    ...
                    {/* RIGHT SIDEBAR BUY CARD FOR LARGE SCREENS */}
                        ...
                        <div className='py-4'>
                            {courseContent.map((section) => (
                                <div key={section._id} className='overflow-hidden border border-solid border-richblack-600 bg-richblack-700 text-richblack-5 last:mb-0'>
                                    ...
                                    {/* SubSections */}
                                    <div className={`relative ${isActive.includes(section._id) ? "h-auto" : "h-0"} overflow-hidden bg-richblack-900 transition-[height] duration-[0.35s] ease-[ease]`}>
