...
const EnrolledCourses = () => {
  ...
  const getEnrolledCoursesHandler = async () => {
    ...
    try {
      ...
      //  response is already an array (from profileAPI.js)
      ...
      console.log("Parsed enrolled courses:", courses);
              ...
              <div
                ...
                onClick={() => {
                  if (hasContent) {
                    ...
                    alert(
                      "This course currently has no sections or subsections to view."
                    );
                  }
                }}
              >
